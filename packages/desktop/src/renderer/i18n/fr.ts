export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MAFW",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MAFW a été téléchargée. Voulez-vous l'installer et redémarrer ?",
