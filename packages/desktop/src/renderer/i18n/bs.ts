export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MAFW-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MAFW-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
