export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MAFW",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MAFW. ¿Quieres instalarla y reiniciar?",
