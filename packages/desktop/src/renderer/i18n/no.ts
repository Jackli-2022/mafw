export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MAFW",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MAFW er lastet ned. Vil du installere den og starte på nytt?",
