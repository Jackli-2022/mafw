export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MAFW",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MAFW er blevet downloadet. Vil du installere den og genstarte?",
