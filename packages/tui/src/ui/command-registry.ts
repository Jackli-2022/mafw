...
export const COMMAND_REGISTRY: CommandDef[] = [
  ...
  { name: 'plan', description: '规划模式（只读 plan agent 出方案，作用于后续消息）', category: '模型', immediate: true },
  { name: 'build', description: '执行模式（完整工具集，作用于后续消息）', category: '模型', immediate: true },
  { name: 'agent', description: '选择 Agent（含默认/plan/build）', category: '模型', immediate: true },
